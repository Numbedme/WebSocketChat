...
public class MessageService {
    ...
    @Autowired
    public MessageService(MessageRepository messageRepository, ChatRepository chatRepository, SimpMessagingTemplate template) {
        this.messageRepository = messageRepository;
        this.chatRepository = chatRepository;
        this.template = template;
    }

    public Message addMessageToChat(String chatName, Message message){
